	...
	<div class="col-md-12">
		<div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-list"></i>
                    <span class="caption-subject bold uppercase">Kategori Akomodasi</span>
                </div>
            </div>
            <div class="portlet-body">
            	<div class="row">         			
                    <div class="col-md-9">
	                    <a href="<?=site_url('panel/akomodasi_kategori/form')?>" class="btn green">
            		...
            		<div class="col-md-3">
            			<h4>Cari Data</h4>
		           		<form method="GET" action="<?=site_url('panel/akomodasi_kategori')?>">
							...
							<?php foreach($data as $key => $c): ?>
								<tr>
									<td class="text-center">
										<a href="<?=site_url('panel/akomodasi_kategori/form/' . $c->kategori_id)?>" class="btn blue btn-xs" title="Perbaharui / Update">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<a href="<?=site_url('panel/akomodasi_kategori')?>" id="btn-yes" class="btn red">
...
<script type="text/javascript">
	...
	{
		$('#modal-hapus #btn-yes').attr({'href' : '<?=site_url('panel/akomodasi_kategori/hapus')?>/' + id});
		$('#modal-hapus').modal();
	}
</script>