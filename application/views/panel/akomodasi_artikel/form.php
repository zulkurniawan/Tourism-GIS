	...
	<div class="col-md-12">
		<div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-list"></i>
                    <span class="caption-subject bold uppercase">Artikel untuk Akomodasi : <?=$nama_objek?></span>
                </div>
            </div>
            <div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('panel/akomodasi_artikel/index/' . $uri_kategori . '/' . $uri_objek)?>" class="btn blue">
							<i class="fa fa-history"></i> Kembali
						</a>
					</div>
				</div>
				<hr/>
				<form class="form-horizontal" method="POST" action="<?=site_url('panel/akomodasi_artikel/submit/' . $uri_kategori . '/' . $uri_objek . '/' . $id)?>" enctype="multipart/form-data">
				    <div class="row">
				    	<div class="col-md-12">
							<div class="portlet light">
					            <div class="portlet-body">
				    	...
				    	<div class="col-md-12">
						    <div class="form-group form-md-line-input">
						        <div class="col-md-12">
						            ...
						            <a href="<?=site_url('panel/akomodasi_artikel/index/' . $uri_kategori . '/' . $uri_objek)?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
	...
	function sendFile(file, editor, welEditable) {
        ...
        $.ajax({
            data 			: data,
            type 			: "POST",
            url 			: "<?=site_url('panel/akomodasi_artikel/upload_gambar_isi')?>",
            cache 		 	: false,
            contentType 	: false,
            processData 	: false,
