	...
	<div class="col-md-12">
		<div class="portlet light">
            <div class="portlet-title">
				...
				<div class="actions">
				    <a class="btn blue" href="<?=site_url('panel/akomodasi_artikel/index/' . $uri_kategori . '/' . $uri_objek)?>">
				    	<i class="fa fa-history"></i> Kembali
				    </a>
				    <?php if($login_level == 'Administrator' || $login_uid == $data->user_id){ ?>
						<a href="<?=site_url('panel/akomodasi_artikel/form/' . $uri_kategori . '/' . $uri_objek . '/' . $data->artikel_id)?>" class="btn blue btn-xs" title="Perbaharui / Update">
...
<div class="modal fade" id="modal-status" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        	<form class="form-horizontal" action="<?=site_url('panel/akomodasi_artikel/set_status/' . $uri_kategori . '/' . $uri_objek . '/' . $data->artikel_id)?>" method="POST">
