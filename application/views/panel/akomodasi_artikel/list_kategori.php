		...
		<div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase">Pilih Kategori Akomodasi</span>
                </div>
            </div>
            		...
            		<?php foreach ($data as $key => $c) { ?>
            			<div class="col-md-4">
							<div class="portlet light bordered">
					            ...
					            <div class="portlet-body">
									<ul class="list-group">
									    <li class="list-group-item"> Akomodasi
									...
									<hr/>
					            	<a href="<?=site_url('panel/akomodasi_artikel/index/' . $c->kategori_id . '-' . format_uri($c->nama_kategori))?>" class="btn btn-info btn-block">
