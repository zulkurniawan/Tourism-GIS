	...
	<div class="col-md-12">
		<div class="portlet light">
            ...
            <div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('panel/kategori')?>" class="btn blue">
				...
				<div class="row">		
					<div class="col-md-12">
						<form class="form-horizontal" method="POST" action="<?=site_url('panel/kategori/submit/' . $id)?>" enctype="multipart/form-data">
						    ...
						    <div class="form-group form-md-line-input">
						        <div class="col-md-offset-4 col-md-6">
						            ...
						            <a href="<?=site_url('panel/kategori')?>" class="btn btn-warning">
