	   ...
	   <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject sbold uppercase">Objek <?=$data_objek->nama?></span>
                </div>
            </div>
            <div class="portlet-body">
                <a href="<?=site_url('panel/statistik_objek')?>" class="btn blue">
                    <i class="fa fa-history"></i>&nbsp;Kembali
                </a>
                <hr/>
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-inline" action="<?=site_url('panel/statistik_objek/detail/' . $data_objek->objek_id)?>" method="GET">
