	...
	<div class="col-md-12">
		<div class="portlet light">
            ...
            <div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('panel/galeri/index/' . $uri_kategori . '/' . $uri_objek)?>" class="btn blue">
							<i class="fa fa-history"></i> Kembali
						</a>
					</div>
				</div>
				<hr/>
				<form class="form-horizontal" method="POST" action="<?=site_url('panel/galeri/submit/' . $uri_kategori . '/' . $uri_objek . '/' . $id)?>" enctype="multipart/form-data">
				    <div class="row">
				    	<div class="col-md-12">
							<div class="portlet light">
					            <div class="portlet-body">
				    	...
				    	<div class="col-md-12">
						    <div class="form-group form-md-line-input">
						        <div class="col-md-12">
						            ...
						            <a href="<?=site_url('panel/galeri/index/' . $uri_kategori . '/' . $uri_objek)?>" class="btn btn-warning pull-right">
