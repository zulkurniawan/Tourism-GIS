	...
	<div class="col-md-12">
		<div class="portlet light">
            ...
            <div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('panel/galeri/index/' . $uri_kategori)?>" class="btn blue">
							<i class="fa fa-history hidden-xs"></i> Kembali
						</a>
					</div>
				</div>
				<hr/>
                <form id="fileupload" action="<?=site_url('panel/galeri_uploadhandler/index/' . $uri_kategori . '/' . $uri_objek)?>" method="POST" enctype="multipart/form-data">
	                    ...
	                    <table role="presentation" class="table table-striped clearfix">
	                    	<thead>
	                    		<tr>
	                    			...
	                    			<th class="col-md-2">Kontributor</th>
	                    		</tr>
	                    	</thead>
