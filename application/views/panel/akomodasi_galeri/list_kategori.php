		...
		<div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase">Pilih Galeri Akomodasi</span>
                </div>
            </div>
            			...
            			<div class="col-md-4">
							<div class="portlet light bordered">
					            ...
					            <div class="portlet-body">
									...
									<hr/>
					            	<a href="<?=site_url('panel/akomodasi_galeri/index/' . $c->kategori_id . '-' . format_uri($c->nama_kategori))?>" class="btn btn-info btn-block">
