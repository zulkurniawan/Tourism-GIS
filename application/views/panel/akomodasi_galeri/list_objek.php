	...
	<div class="col-md-12">
		<div class="portlet light">
            ...
            <div class="portlet-body">
            	<div class="row">
            		<div class="col-md-12">
            			<a href="<?=site_url('panel/akomodasi_galeri')?>" class="btn blue"><i class="fa fa-history"></i> Kembali</a>
            		</div>
            	</div>
            	<hr/>
            	<div class="row">
            			...
            			<div class="col-md-4">
							<div class="portlet light bordered">
					            ...
					            <div class="portlet-body">
					            	...
					            	<hr/>
					            	<a href="<?=site_url('panel/akomodasi_galeri/index/' . $uri_kategori . '/' . $c->objek_id . '-' . format_uri($c->nama))?>" class="btn btn-info btn-block">
