	...
	<div class="col-md-12">
		<div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-list"></i>
                    <span class="caption-subject bold uppercase">Statistik Akomodasi</span>
                </div>
            </div>
            <div class="portlet-body">
            	<div class="row">
            		...
            		<div class="col-md-8">
            			<h4>Cari Data</h4>
		           		<form method="GET" action="<?=site_url('panel/statistik_akomodasi')?>">
		           			<div class="row">
							...
							<?php foreach($data as $key => $c): ?>
								<tr>
									<td class="text-center">
										<a href="<?=site_url('panel/statistik_akomodasi/detail/' . $c->objek_id)?>" class="btn blue btn-xs" title="Perbaharui / Update">
