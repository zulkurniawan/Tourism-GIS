		...
		<div class="portlet light">
            ...
            <div class="portlet-body">
				<div class="row" style="margin-bottom: 10px;">
					<div class="col-md-12">
						<a href="<?=site_url('panel/akomodasi_objek')?>" class="btn blue">
							<i class="fa fa-history"></i> Kembali
						</a>
					</div>
				</div>
				<form class="form-horizontal" method="POST" action="<?=site_url('panel/akomodasi_objek/submit/' . $id)?>" enctype="multipart/form-data">
					...
					<div class="row">		
						...
						<div class="col-md-6">
							<div class="portlet light bordered">
					            ...
					            <div class="portlet-body">
								    <div class="form-group form-md-line-input">
								        <label class="col-md-4 control-label">Barang / Jasa</label>
								        <div class="col-md-8">
								        	<textarea class="form-control" name="akomodasi_jasa" id="akomodasi_jasa" rows="7"><?=@$data->akomodasi_jasa?></textarea>
											<div class="form-control-focus"> </div>
								        </div>
								    </div>							
								    <div class="form-group form-md-line-input">
								        <label class="col-md-4 control-label">Layanan Tambahan</label>
								        <div class="col-md-8">
								        	<textarea class="form-control" name="akomodasi_layanan_tambahan" id="akomodasi_layanan_tambahan" rows="7"><?=@$data->akomodasi_layanan_tambahan?></textarea>
											<div class="form-control-focus"> </div>
								        </div>
								    </div>							
						...
						<div class="col-md-12">
							<div class="portlet light bordered">
					            <div class="portlet-title">
					                <div class="caption">
					                    <i class="icon-note"></i>
					                    <span class="caption-subject bold uppercase">Berikan Gambaran / Deskripsi mengenai Akomodasi</span>
					                </div>
					            </div>
					            <div class="portlet-body">
								    <div class="form-group form-md-line-input">
						...
						<div class="col-md-12">
						    <div class="form-group form-md-line-input">
						        <div class="col-md-12">
						            ...
						            <a href="<?=site_url('panel/akomodasi_objek')?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
	var ComponentsEditors = function() {
	    var s = function() {
	            ...
	            $("#akomodasi_jasa, #akomodasi_layanan_tambahan").summernote({
	                height: 150,
					toolbar: [
	...
	function sendFile(file, editor, welEditable) {
        ...
        $.ajax({
            data 			: data,
            type 			: "POST",
            url 			: "<?=site_url('panel/akomodasi_objek/upload_gambar_deskripsi')?>",
            cache 		 	: false,
            contentType 	: false,
            processData 	: false,
