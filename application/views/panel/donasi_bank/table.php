	...
	<div class="col-md-12">
		<div class="portlet light">
            ...
            <div class="portlet-body">
            	<div class="row">         			
                    <div class="col-md-9">
	                    <a href="<?=site_url('panel/donasi_bank/form')?>" class="btn green">
            		...
            		<div class="col-md-3">
            			<h4>Cari Data</h4>
		           		<form method="GET" action="<?=site_url('panel/donasi_bank')?>">
						...
						<?php foreach($data as $key => $c): ?>
							<tr>
								<td class="text-center">
									<a href="<?=site_url('panel/donasi_bank/form/' . $c->bank_id)?>" class="btn blue btn-xs" title="Perbaharui / Update">
										<i class="fa fa-edit"></i>
									</a>
									<a onclick="confirm_hapus('<?=$c->bank_id?>')" class="btn red btn-xs" title="Hapus">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<a href="<?=site_url('panel/donasi_bank')?>" id="btn-yes" class="btn red">
...
<script type="text/javascript">
	...
	{
		$('#modal-hapus #btn-yes').attr({'href' : '<?=site_url('panel/donasi_bank/hapus')?>/' + id});
		$('#modal-hapus').modal();
	}
</script>