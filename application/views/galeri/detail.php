	...
	<?php foreach($data->data as $key => $c): ?>
		<div class="blog-page blog-content-2">
			<div class="blog-single-content bordered blog-container">
				...
				<a href="<?=site_url('galeri/index/' . $data->objek_wisata->objek_id . '-' . $data->objek_wisata->url_seo)?>" class="btn btn-sm grey">
					<i class="fa fa-list"></i><span class="hidden-xs hidden-sm">&nbsp;&nbsp;Index Galeri</span>
				</a>
	            ...
	            <div class="blog-single-head">
	                <h1 class="blog-single-head-title"><?=$c->nama?></h1>
	            </div>
	            <div class="blog-single-img">
		            ...
		            <div class="blog-single-foot">
		                <ul class="blog-post-tags">
		                    ...
		                    <li class="uppercase">
		                        <a href="javascript:;"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<?=$c->tgl_upload?></a>
		                    </li>
		                </ul>
		            </div>
		        </div>
