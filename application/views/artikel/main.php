			...
			<div class="portlet light bordered">
	            ...
	            <div class="portlet-body">
					...
					<div class="btn-group btn-group-justified">
						<a href="<?=site_url('artikel/index/' . $data->objek_wisata->objek_id . '-' . $data->objek_wisata->url_seo)?>" class="btn btn-default">
							<i class="fa fa-list"></i>&nbsp;&nbsp;Artikel
						</a>
						<a href="<?=site_url('galeri/index/' . $data->objek_wisata->objek_id . '-' . $data->objek_wisata->url_seo)?>" class="btn btn-info">
